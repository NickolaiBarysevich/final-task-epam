...
public class AssignRoomCommandTest {
    ...
    private static final Application EMPTY_APPLICATION =
            new Application(0L, 0, Date.valueOf("2018-10-10"), Date.valueOf("2018-10-10"), null, 0L, 0L);
    ...
    public void shouldReturnManagementRedirect() throws ServiceException {
        ...
        when(billService.isApproved(anyLong())).thenReturn(false);
        ...
        when(applicationService.findApplicationById(anyLong())).thenReturn(Optional.of(EMPTY_APPLICATION));
    ...
    public void shouldReturnManagementRedirectWithErrorMessage() throws ServiceException {
        ...
        when(billService.isApproved(anyLong())).thenReturn(true);
        when(billService.makeABill(any(Bill.class))).thenReturn(true);
        ...
        Assert.assertEquals(actual, MANAGEMENT_REDIRECT + MANAGEMENT_ERROR_IS_ASSIGNED);
    }
